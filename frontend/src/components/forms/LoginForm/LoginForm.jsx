...
import { login, getUserInfo } from '../../../redux/auth/operations.js';
import { selectIsLoading } from '../../../redux/auth/selectors.js'; // ← додай свій селектор

import css from './LoginForm.module.css';
import Loader from '../../common/Loader/Loader.jsx'; // ← компонент лоадера
